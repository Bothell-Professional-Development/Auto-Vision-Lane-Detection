...
double bezier_calc(double wheelAngle, double laneCenter, double laneAngle, double progressPoint) {
	...
	//Step one, get all 4 points  (the 30's should eventually be replaced by som fraction of PointThree_y (or some other value) but that all depends on if we end up getting that in as a variable)
